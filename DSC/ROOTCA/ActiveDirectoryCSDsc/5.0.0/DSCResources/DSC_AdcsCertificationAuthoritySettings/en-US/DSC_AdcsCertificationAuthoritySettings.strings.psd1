# Localized resources for DSC_AdcsCertificationAuthority

ConvertFrom-StringData @'
    GettingAdcsCaSettingsMessage = Getting Active Directory certificate authority Settings.
    ...
    SettingAdcsCaSettingsMessage = Setting Active Directory certificate authority Settings.
    ...
    TestingAdcsCaSettingsMessage = Testing Active Directory certificate authority Settings.
'@

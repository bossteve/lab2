configuration PREPAREADEXCHANGE1622
{
   param
   (
    ...
    Node localhost
    {
        ...
        Script PrepareExchange2016AD
        {
            SetScript =
            {
                ...
                J:\Setup.exe /PrepareSchema /DomainController:"$using:dc1Name" /IAcceptExchangeServerLicenseTerms_DiagnosticDataOFF
                J:\Setup.exe /PrepareAD /on:"$using:ExchangeOrgName" /DomainController:"$using:dc1Name" /IAcceptExchangeServerLicenseTerms_DiagnosticDataOFF
